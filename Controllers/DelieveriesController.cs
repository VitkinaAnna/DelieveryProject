...
namespace DelieveryWebApplication.Controllers
{
    ...
    public class DelieveriesController : Controller
    {
        ...
        {
            var delieveryContext = _context.Delieveries.Include(d => d.Dish).Include(d => d.Order);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var delievery = await _context.Delieveries
                .Include(d => d.Dish)
                .Include(d => d.Order)
        ...
        public async Task<IActionResult> Create([Bind("DishId,OrderId,Amount,DelieveryId")] Delievery delievery)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "OrderId", "OrderId", delievery.OrderId);
            return View(delievery);
        }
